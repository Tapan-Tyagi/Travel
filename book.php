      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>where to :</span><br><br>
             <select id="tour-package" name="location" required>
            <option value="" disabled selected>-- Select a package --</option>
            <option value="Dubai Tour Packages">Dubai Tour Packages</option>
            <option value="Delhi Tour Packages">Delhi Tour Packages</option>
            <option value="Japan Tour Packages">Japan Tour Packages</option>
            <option value="Australia Tour Packages">Australia Tour Packages</option>
            <option value="China Tour Packages">China Tour Packages</option>
            <option value="Singapore Tour Packages">Singapore Tour Packages</option>
            <option value="Spain Tour Packages">Spain Tour Packages</option>
            <option value="Canada Tour Packages">Canada Tour Packages</option>
            <option value="Bali Tour Packages">Bali Tour Packages</option>
            <option value="Nepal Tour Packages">Nepal Tour Packages</option>
            <option value="Bangladesh Tour Packages">Bangladesh Tour Packages</option>
        </select>
         </div>
         <div class="inputBox">
            <span>how many :</span>
